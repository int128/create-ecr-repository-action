...
var credentialProviderLogin = __webpack_require__(1362);

const resolveCredentialSource = (credentialSource, profileName, logger) => {
    const sourceProvidersMap = {
        EcsContainer: async (options) => {
            const { fromHttp } = await __webpack_require__.e(/* import() */ 340).then(__webpack_require__.bind(__webpack_require__, 7340));
        ...
        Environment: async (options) => {
            ...
            const { fromEnv } = await Promise.resolve(/* import() */).then(__webpack_require__.t.bind(__webpack_require__, 5788, 19));
...
const resolveAssumeRoleCredentials = async (profileName, profiles, options, callerClientConfig, visitedProfiles = {}, resolveProfileData) => {
    ...
    if (!options.roleAssumer) {
        const { getDefaultRoleAssumer } = await Promise.all(/* import() */[__webpack_require__.e(948), __webpack_require__.e(182)]).then(__webpack_require__.t.bind(__webpack_require__, 6182, 23));
...
const resolveProcessCredentials = async (options, profile) => __webpack_require__.e(/* import() */ 888).then(__webpack_require__.t.bind(__webpack_require__, 1888, 19)).then(({ fromProcess }) => fromProcess({
    ...options,
    profile,
...
const resolveSsoCredentials = async (profile, profileData, options = {}, callerClientConfig) => {
    const { fromSSO } = await Promise.all(/* import() */[__webpack_require__.e(948), __webpack_require__.e(370)]).then(__webpack_require__.t.bind(__webpack_require__, 1370, 19));
    return fromSSO({
        profile,
...
const isWebIdentityProfile = (arg) => Boolean(arg) &&
    ...
    typeof arg.role_arn === "string" &&
    ["undefined", "string"].indexOf(typeof arg.role_session_name) > -1;
const resolveWebIdentityCredentials = async (profile, options, callerClientConfig) => Promise.all(/* import() */[__webpack_require__.e(948), __webpack_require__.e(644)]).then(__webpack_require__.t.bind(__webpack_require__, 644, 23)).then(({ fromTokenFile }) => fromTokenFile({
...
class LoginCredentialsFetcher {
    ...
    async refresh(token) {
        const { SigninClient, CreateOAuth2TokenCommand } = await Promise.all(/* import() */[__webpack_require__.e(948), __webpack_require__.e(300)]).then(__webpack_require__.t.bind(__webpack_require__, 3300, 23));
