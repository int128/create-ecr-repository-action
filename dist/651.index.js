...
const ruleset_1 = __webpack_require__(6707);
...
var middlewareHostHeader = __webpack_require__(8117);
var middlewareLogger = __webpack_require__(9849);
var middlewareRecursionDetection = __webpack_require__(2337);
var middlewareUserAgent = __webpack_require__(4758);
...
var httpAuthSchemeProvider = __webpack_require__(7444);
var runtimeConfig = __webpack_require__(4141);
...
const package_json_1 = tslib_1.__importDefault(__webpack_require__(794));
const core_1 = __webpack_require__(3920);
...
const runtimeConfig_shared_1 = __webpack_require__(4050);
...
const httpAuthSchemeProvider_1 = __webpack_require__(7444);
const endpointResolver_1 = __webpack_require__(4570);
const getRuntimeConfig = (config) => {
    return {
...
var protocolHttp = __webpack_require__(6204);
var core = __webpack_require__(4046);
var propertyProvider = __webpack_require__(4200);
...
var propertyProvider = __webpack_require__(4200);
var sharedIniFileLoader = __webpack_require__(5285);
var client = __webpack_require__(9904);
var tokenProviders = __webpack_require__(7031);
...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, callerClientConfig, profile, filepath, configFilepath, ignoreCache, logger, }) => {
    ...
    const { SSOClient, GetRoleCredentialsCommand } = await Promise.resolve().then(function () { return __webpack_require__(1114); });
    const sso = ssoClient ||
...
var clientSso = __webpack_require__(6459);
...
var client = __webpack_require__(9904);
var httpAuthSchemes = __webpack_require__(5859);
var propertyProvider = __webpack_require__(4200);
var sharedIniFileLoader = __webpack_require__(5285);
...
const getSsoOidcClient = async (ssoRegion, init = {}, callerClientConfig) => {
    const { SSOOIDCClient } = await __webpack_require__.e(/* import() */ 641).then(__webpack_require__.t.bind(__webpack_require__, 1641, 19));
...
const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}, callerClientConfig) => {
    const { CreateTokenCommand } = await __webpack_require__.e(/* import() */ 641).then(__webpack_require__.t.bind(__webpack_require__, 1641, 19));
