...
const core_1 = __webpack_require__(4412);
...
const util_endpoints_1 = __webpack_require__(5464);
const util_endpoints_2 = __webpack_require__(6382);
const ruleset_1 = __webpack_require__(1393);
...
var middlewareHostHeader = __webpack_require__(5592);
var middlewareLogger = __webpack_require__(510);
var middlewareRecursionDetection = __webpack_require__(32);
var middlewareUserAgent = __webpack_require__(4498);
...
var httpAuthSchemeProvider = __webpack_require__(9651);
var runtimeConfig = __webpack_require__(7498);
var regionConfigResolver = __webpack_require__(7090);
var protocolHttp = __webpack_require__(6397);
var middlewareSerde = __webpack_require__(5369);
var core$1 = __webpack_require__(4412);
...
const package_json_1 = tslib_1.__importDefault(__webpack_require__(1551));
const core_1 = __webpack_require__(4412);
const util_user_agent_node_1 = __webpack_require__(1688);
...
const runtimeConfig_shared_1 = __webpack_require__(9731);
...
const httpAuthSchemeProvider_1 = __webpack_require__(9651);
const endpointResolver_1 = __webpack_require__(3053);
const getRuntimeConfig = (config) => {
    return {
...
var client = __webpack_require__(3700);
...
var client = __webpack_require__(3700);
var tokenProviders = __webpack_require__(2646);
...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, profile, filepath, configFilepath, ignoreCache, logger, }) => {
    ...
    const { SSOClient, GetRoleCredentialsCommand } = await Promise.resolve().then(function () { return __webpack_require__(9597); });
    const sso = ssoClient ||
...
var clientSso = __webpack_require__(9816);
...
var client = __webpack_require__(3700);
var httpAuthSchemes = __webpack_require__(2983);
var propertyProvider = __webpack_require__(6933);
var sharedIniFileLoader = __webpack_require__(5352);
...
const getSsoOidcClient = async (ssoRegion, init = {}) => {
    const { SSOOIDCClient } = await __webpack_require__.e(/* import() */ 278).then(__webpack_require__.t.bind(__webpack_require__, 8278, 19));
...
const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}) => {
    const { CreateTokenCommand } = await __webpack_require__.e(/* import() */ 278).then(__webpack_require__.t.bind(__webpack_require__, 8278, 19));
...
//# sourceMappingURL=554.index.js.map