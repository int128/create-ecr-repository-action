...
var client = __webpack_require__(9418);
var tokenProviders = __webpack_require__(2981);
...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, callerClientConfig, profile, filepath, configFilepath, ignoreCache, logger, }) => {
    ...
    const { SSOClient, GetRoleCredentialsCommand } = await Promise.resolve().then(function () { return __webpack_require__(4856); });
    const sso = ssoClient ||
...
var sso = __webpack_require__(762);
...
const ruleset_1 = __webpack_require__(2208);
...
var middlewareHostHeader = __webpack_require__(1783);
...
var middlewareRetry = __webpack_require__(9215);
var smithyClient = __webpack_require__(7841);
var httpAuthSchemeProvider = __webpack_require__(3186);
var runtimeConfig = __webpack_require__(1804);
var regionConfigResolver = __webpack_require__(9626);
var protocolHttp = __webpack_require__(839);
var schemas_0 = __webpack_require__(3442);
var errors = __webpack_require__(6566);
var SSOServiceException = __webpack_require__(7182);
...
const SSOServiceException_1 = __webpack_require__(7182);
...
const package_json_1 = tslib_1.__importDefault(__webpack_require__(3363));
...
const runtimeConfig_shared_1 = __webpack_require__(2317);
...
exports.getRuntimeConfig = void 0;
const httpAuthSchemes_1 = __webpack_require__(3989);
const protocols_1 = __webpack_require__(1526);
...
const httpAuthSchemeProvider_1 = __webpack_require__(3186);
const endpointResolver_1 = __webpack_require__(955);
const schemas_0_1 = __webpack_require__(3442);
const getRuntimeConfig = (config) => {
    return {
...
const errors_1 = __webpack_require__(6566);
const SSOServiceException_1 = __webpack_require__(7182);
...
var client = __webpack_require__(9418);
var httpAuthSchemes = __webpack_require__(3989);
var propertyProvider = __webpack_require__(8991);
var sharedIniFileLoader = __webpack_require__(3083);
...
const getSsoOidcClient = async (ssoRegion, init = {}, callerClientConfig) => {
    const { SSOOIDCClient } = await __webpack_require__.e(/* import() */ 668).then(__webpack_require__.t.bind(__webpack_require__, 6668, 23));
...
const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}, callerClientConfig) => {
    const { CreateTokenCommand } = await __webpack_require__.e(/* import() */ 668).then(__webpack_require__.t.bind(__webpack_require__, 6668, 23));
