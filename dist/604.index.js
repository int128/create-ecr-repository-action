...
const fromWebToken_1 = __webpack_require__(9061);
...
const fromWebToken = (init) => async (awsIdentityProperties) => {
    ...
    if (!roleAssumerWithWebIdentity) {
        const { getDefaultRoleAssumerWithWebIdentity } = await Promise.resolve().then(() => __importStar(__webpack_require__(5371)));
...
var fromTokenFile = __webpack_require__(2908);
var fromWebToken = __webpack_require__(9061);
