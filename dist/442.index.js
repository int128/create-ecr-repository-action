...
const ruleset_1 = __webpack_require__(2130);
...
var middlewareHostHeader = __webpack_require__(2169);
var middlewareLogger = __webpack_require__(1917);
var middlewareRecursionDetection = __webpack_require__(8493);
var middlewareUserAgent = __webpack_require__(2685);
...
var httpAuthSchemeProvider = __webpack_require__(2047);
var runtimeConfig = __webpack_require__(3662);
...
const package_json_1 = tslib_1.__importDefault(__webpack_require__(9447));
const core_1 = __webpack_require__(2701);
...
const runtimeConfig_shared_1 = __webpack_require__(8551);
...
const httpAuthSchemeProvider_1 = __webpack_require__(2047);
const endpointResolver_1 = __webpack_require__(3721);
const getRuntimeConfig = (config) => {
    return {
...
var client = __webpack_require__(7421);
var tokenProviders = __webpack_require__(9682);
...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, callerClientConfig, profile, filepath, configFilepath, ignoreCache, logger, }) => {
    ...
    const { SSOClient, GetRoleCredentialsCommand } = await Promise.resolve().then(function () { return __webpack_require__(2869); });
    const sso = ssoClient ||
...
var clientSso = __webpack_require__(5084);
...
var client = __webpack_require__(7421);
var httpAuthSchemes = __webpack_require__(512);
var propertyProvider = __webpack_require__(4200);
var sharedIniFileLoader = __webpack_require__(5285);
...
const getSsoOidcClient = async (ssoRegion, init = {}, callerClientConfig) => {
    const { SSOOIDCClient } = await __webpack_require__.e(/* import() */ 658).then(__webpack_require__.t.bind(__webpack_require__, 6658, 19));
...
const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}, callerClientConfig) => {
    const { CreateTokenCommand } = await __webpack_require__.e(/* import() */ 658).then(__webpack_require__.t.bind(__webpack_require__, 6658, 19));
