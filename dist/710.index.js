...
const ruleset_1 = __webpack_require__(778);
...
var middlewareHostHeader = __webpack_require__(1960);
var middlewareLogger = __webpack_require__(1218);
var middlewareRecursionDetection = __webpack_require__(1772);
var middlewareUserAgent = __webpack_require__(5274);
var configResolver = __webpack_require__(7358);
var core = __webpack_require__(3234);
var schema = __webpack_require__(7162);
var middlewareContentLength = __webpack_require__(5550);
var middlewareEndpoint = __webpack_require__(3065);
var middlewareRetry = __webpack_require__(9579);
var smithyClient = __webpack_require__(2958);
var httpAuthSchemeProvider = __webpack_require__(8759);
var runtimeConfig = __webpack_require__(1529);
...
const package_json_1 = tslib_1.__importDefault(__webpack_require__(7475));
const core_1 = __webpack_require__(3696);
...
const runtimeConfig_shared_1 = __webpack_require__(9983);
...
const httpAuthSchemeProvider_1 = __webpack_require__(8759);
const endpointResolver_1 = __webpack_require__(8833);
const getRuntimeConfig = (config) => {
    return {
...
var client = __webpack_require__(2416);
var tokenProviders = __webpack_require__(7926);
...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, profile, filepath, configFilepath, ignoreCache, logger, }) => {
    ...
    const { SSOClient, GetRoleCredentialsCommand } = await Promise.resolve().then(function () { return __webpack_require__(4977); });
    const sso = ssoClient ||
...
var clientSso = __webpack_require__(6676);
...
var client = __webpack_require__(2416);
var httpAuthSchemes = __webpack_require__(1507);
var propertyProvider = __webpack_require__(98);
var sharedIniFileLoader = __webpack_require__(2787);
...
const getSsoOidcClient = async (ssoRegion, init = {}) => {
    const { SSOOIDCClient } = await __webpack_require__.e(/* import() */ 678).then(__webpack_require__.t.bind(__webpack_require__, 7678, 19));
...
const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}) => {
    const { CreateTokenCommand } = await __webpack_require__.e(/* import() */ 678).then(__webpack_require__.t.bind(__webpack_require__, 7678, 19));
