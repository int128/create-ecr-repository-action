...
const util_endpoints_1 = __webpack_require__(5676);
const util_endpoints_2 = __webpack_require__(2313);
const ruleset_1 = __webpack_require__(9259);
...
var middlewareHostHeader = __webpack_require__(432);
var middlewareLogger = __webpack_require__(9554);
var middlewareRecursionDetection = __webpack_require__(4724);
var middlewareUserAgent = __webpack_require__(667);
...
var httpAuthSchemeProvider = __webpack_require__(1980);
var runtimeConfig = __webpack_require__(3237);
var regionConfigResolver = __webpack_require__(6090);
var protocolHttp = __webpack_require__(2664);
var middlewareSerde = __webpack_require__(7602);
var core$1 = __webpack_require__(9283);
...
const package_json_1 = tslib_1.__importDefault(__webpack_require__(2282));
const core_1 = __webpack_require__(9283);
const util_user_agent_node_1 = __webpack_require__(9051);
...
const runtimeConfig_shared_1 = __webpack_require__(2442);
...
const httpAuthSchemeProvider_1 = __webpack_require__(1980);
const endpointResolver_1 = __webpack_require__(8898);
const getRuntimeConfig = (config) => {
    return {
...
var client = __webpack_require__(515);
...
var client = __webpack_require__(515);
var tokenProviders = __webpack_require__(4463);
...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, profile, filepath, configFilepath, ignoreCache, logger, }) => {
    ...
    const { SSOClient, GetRoleCredentialsCommand } = await Promise.resolve().then(function () { return __webpack_require__(4154); });
    const sso = ssoClient ||
...
var clientSso = __webpack_require__(4723);
...
var client = __webpack_require__(515);
var httpAuthSchemes = __webpack_require__(8462);
var propertyProvider = __webpack_require__(4124);
var sharedIniFileLoader = __webpack_require__(6547);
...
const getSsoOidcClient = async (ssoRegion, init = {}) => {
    const { SSOOIDCClient } = await __webpack_require__.e(/* import() */ 1).then(__webpack_require__.t.bind(__webpack_require__, 6001, 19));
...
const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}) => {
    const { CreateTokenCommand } = await __webpack_require__.e(/* import() */ 1).then(__webpack_require__.t.bind(__webpack_require__, 6001, 19));
