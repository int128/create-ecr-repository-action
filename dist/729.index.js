...
const ruleset_1 = __webpack_require__(7649);
...
var middlewareUserAgent = __webpack_require__(6463);
var configResolver = __webpack_require__(705);
var core = __webpack_require__(2744);
...
var httpAuthSchemeProvider = __webpack_require__(2050);
var runtimeConfig = __webpack_require__(4435);
...
const package_json_1 = tslib_1.__importDefault(__webpack_require__(9776));
const core_1 = __webpack_require__(4504);
...
const runtimeConfig_shared_1 = __webpack_require__(5040);
...
const httpAuthSchemeProvider_1 = __webpack_require__(2050);
const endpointResolver_1 = __webpack_require__(1167);
const getRuntimeConfig = (config) => {
    return {
...
var client = __webpack_require__(8296);
var tokenProviders = __webpack_require__(1809);
...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, callerClientConfig, profile, filepath, configFilepath, ignoreCache, logger, }) => {
    ...
    const { SSOClient, GetRoleCredentialsCommand } = await Promise.resolve().then(function () { return __webpack_require__(5400); });
    const sso = ssoClient ||
...
var clientSso = __webpack_require__(6985);
...
var client = __webpack_require__(8296);
var httpAuthSchemes = __webpack_require__(1675);
var propertyProvider = __webpack_require__(5169);
var sharedIniFileLoader = __webpack_require__(3628);
...
const getSsoOidcClient = async (ssoRegion, init = {}, callerClientConfig) => {
    const { SSOOIDCClient } = await __webpack_require__.e(/* import() */ 895).then(__webpack_require__.t.bind(__webpack_require__, 1895, 19));
...
const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}, callerClientConfig) => {
    const { CreateTokenCommand } = await __webpack_require__.e(/* import() */ 895).then(__webpack_require__.t.bind(__webpack_require__, 1895, 19));
...
//# sourceMappingURL=729.index.js.map