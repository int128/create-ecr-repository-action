...
var client = __webpack_require__(76);
var tokenProviders = __webpack_require__(5553);
...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, callerClientConfig, profile, filepath, configFilepath, ignoreCache, logger, }) => {
    ...
    const { SSOClient, GetRoleCredentialsCommand } = await Promise.resolve().then(function () { return __webpack_require__(505); });
    const sso = ssoClient ||
...
var sso = __webpack_require__(5801);
...
const ruleset_1 = __webpack_require__(7409);
...
var middlewareUserAgent = __webpack_require__(3002);
...
var httpAuthSchemeProvider = __webpack_require__(7826);
var runtimeConfig = __webpack_require__(1923);
var regionConfigResolver = __webpack_require__(4579);
var protocolHttp = __webpack_require__(2810);
var schemas_0 = __webpack_require__(8689);
var errors = __webpack_require__(9909);
var SSOServiceException = __webpack_require__(2995);
...
const SSOServiceException_1 = __webpack_require__(2995);
...
const package_json_1 = tslib_1.__importDefault(__webpack_require__(4908));
const core_1 = __webpack_require__(5492);
const util_user_agent_node_1 = __webpack_require__(31);
...
const runtimeConfig_shared_1 = __webpack_require__(3936);
...
const httpAuthSchemeProvider_1 = __webpack_require__(7826);
const endpointResolver_1 = __webpack_require__(7500);
const schemas_0_1 = __webpack_require__(8689);
const getRuntimeConfig = (config) => {
    return {
...
const errors_1 = __webpack_require__(9909);
const SSOServiceException_1 = __webpack_require__(2995);
...
const getSsoOidcClient = async (ssoRegion, init = {}, callerClientConfig) => {
    const { SSOOIDCClient } = await __webpack_require__.e(/* import() */ 61).then(__webpack_require__.t.bind(__webpack_require__, 3061, 23));
...
const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}, callerClientConfig) => {
    const { CreateTokenCommand } = await __webpack_require__.e(/* import() */ 61).then(__webpack_require__.t.bind(__webpack_require__, 3061, 23));
...
//# sourceMappingURL=642.index.js.map