...
const shared_ini_file_loader_1 = __webpack_require__(4209);
const node_fs_1 = __webpack_require__(3024);
const fromWebToken_1 = __webpack_require__(6309);
...
const fromWebToken = (init) => async (awsIdentityProperties) => {
    ...
    if (!roleAssumerWithWebIdentity) {
        const { getDefaultRoleAssumerWithWebIdentity } = await Promise.resolve().then(() => __importStar(__webpack_require__(7306)));
...
var fromTokenFile = __webpack_require__(9647);
var fromWebToken = __webpack_require__(6309);
...
//# sourceMappingURL=772.index.js.map