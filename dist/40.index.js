...
const isWebIdentityProfile = (arg) => Boolean(arg) &&
    ...
    typeof arg.role_arn === "string" &&
    ["undefined", "string"].indexOf(typeof arg.role_session_name) > -1;
const resolveWebIdentityCredentials = async (profile, options) => Promise.all(/* import() */[__webpack_require__.e(969), __webpack_require__.e(826)]).then(__webpack_require__.t.bind(__webpack_require__, 3826, 23)).then(({ fromTokenFile }) => fromTokenFile({
