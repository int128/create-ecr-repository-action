...
const client_1 = __webpack_require__(754);
const config_1 = __webpack_require__(6245);
const node_fs_1 = __webpack_require__(3024);
const fromWebToken_1 = __webpack_require__(7077);
...
const fromWebToken = (init) => async (awsIdentityProperties) => {
    ...
    if (!roleAssumerWithWebIdentity) {
        const { getDefaultRoleAssumerWithWebIdentity } = await __webpack_require__.e(/* import() */ 217).then(__webpack_require__.t.bind(__webpack_require__, 1217, 19));
...
var fromTokenFile = __webpack_require__(9967);
var fromWebToken = __webpack_require__(7077);
