...
const ruleset_1 = __webpack_require__(7813);
...
var middlewareRecursionDetection = __webpack_require__(749);
var middlewareUserAgent = __webpack_require__(5606);
...
var httpAuthSchemeProvider = __webpack_require__(8942);
var runtimeConfig = __webpack_require__(7319);
...
const package_json_1 = tslib_1.__importDefault(__webpack_require__(7788));
const core_1 = __webpack_require__(9740);
...
const runtimeConfig_shared_1 = __webpack_require__(1028);
...
const httpAuthSchemeProvider_1 = __webpack_require__(8942);
const endpointResolver_1 = __webpack_require__(1496);
const getRuntimeConfig = (config) => {
    return {
...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, profile, filepath, configFilepath, ignoreCache, logger, }) => {
    ...
    const { SSOClient, GetRoleCredentialsCommand } = await Promise.resolve().then(function () { return __webpack_require__(5148); });
    const sso = ssoClient ||
...
var clientSso = __webpack_require__(1309);
...
const getSsoOidcClient = async (ssoRegion, init = {}) => {
    const { SSOOIDCClient } = await __webpack_require__.e(/* import() */ 59).then(__webpack_require__.t.bind(__webpack_require__, 3059, 19));
...
const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}) => {
    const { CreateTokenCommand } = await __webpack_require__.e(/* import() */ 59).then(__webpack_require__.t.bind(__webpack_require__, 3059, 19));
...
//# sourceMappingURL=957.index.js.map