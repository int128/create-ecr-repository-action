...
var credentialProviderLogin = __webpack_require__(8382);

const resolveCredentialSource = (credentialSource, profileName, logger) => {
    const sourceProvidersMap = {
        EcsContainer: async (options) => {
            const { fromHttp } = await __webpack_require__.e(/* import() */ 349).then(__webpack_require__.bind(__webpack_require__, 6349));
            const { fromContainerMetadata } = await __webpack_require__.e(/* import() */ 885).then(__webpack_require__.t.bind(__webpack_require__, 1885, 19));
            logger?.debug("@aws-sdk/credential-provider-ini - credential_source is EcsContainer");
            return async () => propertyProvider.chain(fromHttp(options ?? {}), fromContainerMetadata(options))().then(setNamedProvider);
        },
        Ec2InstanceMetadata: async (options) => {
            logger?.debug("@aws-sdk/credential-provider-ini - credential_source is Ec2InstanceMetadata");
            const { fromInstanceMetadata } = await __webpack_require__.e(/* import() */ 885).then(__webpack_require__.t.bind(__webpack_require__, 1885, 19));
            return async () => fromInstanceMetadata(options)().then(setNamedProvider);
        },
        Environment: async (options) => {
            logger?.debug("@aws-sdk/credential-provider-ini - credential_source is Environment");
            const { fromEnv } = await Promise.resolve(/* import() */).then(__webpack_require__.t.bind(__webpack_require__, 417, 19));
...
const resolveAssumeRoleCredentials = async (profileName, profiles, options, callerClientConfig, visitedProfiles = {}, resolveProfileData) => {
    ...
    if (!options.roleAssumer) {
        const { getDefaultRoleAssumer } = await Promise.all(/* import() */[__webpack_require__.e(468), __webpack_require__.e(641)]).then(__webpack_require__.t.bind(__webpack_require__, 6641, 23));
...
const resolveProcessCredentials = async (options, profile) => __webpack_require__.e(/* import() */ 745).then(__webpack_require__.t.bind(__webpack_require__, 3745, 19)).then(({ fromProcess }) => fromProcess({
    ...options,
    profile,
...
const resolveSsoCredentials = async (profile, profileData, options = {}, callerClientConfig) => {
    const { fromSSO } = await Promise.all(/* import() */[__webpack_require__.e(468), __webpack_require__.e(797)]).then(__webpack_require__.t.bind(__webpack_require__, 6797, 19));
    return fromSSO({
        profile,
...
const isWebIdentityProfile = (arg) => Boolean(arg) &&
    ...
    typeof arg.role_arn === "string" &&
    ["undefined", "string"].indexOf(typeof arg.role_session_name) > -1;
const resolveWebIdentityCredentials = async (profile, options, callerClientConfig) => Promise.all(/* import() */[__webpack_require__.e(468), __webpack_require__.e(273)]).then(__webpack_require__.t.bind(__webpack_require__, 6273, 23)).then(({ fromTokenFile }) => fromTokenFile({
...
class LoginCredentialsFetcher {
    ...
    async refresh(token) {
        const { SigninClient, CreateOAuth2TokenCommand } = await Promise.all(/* import() */[__webpack_require__.e(468), __webpack_require__.e(117)]).then(__webpack_require__.t.bind(__webpack_require__, 3117, 23));
...
//# sourceMappingURL=857.index.js.map