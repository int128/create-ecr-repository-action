...
const fromWebToken_1 = __webpack_require__(993);
...
const fromWebToken = (init) => async (awsIdentityProperties) => {
    ...
    if (!roleAssumerWithWebIdentity) {
        const { getDefaultRoleAssumerWithWebIdentity } = await __webpack_require__.e(/* import() */ 151).then(__webpack_require__.t.bind(__webpack_require__, 7151, 19));
...
var fromTokenFile = __webpack_require__(1387);
var fromWebToken = __webpack_require__(993);
