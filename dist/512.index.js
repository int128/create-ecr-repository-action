...
var tokenProviders = __webpack_require__(9110);
...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, callerClientConfig, profile, filepath, configFilepath, ignoreCache, logger, }) => {
    ...
    const { SSOClient, GetRoleCredentialsCommand } = await Promise.resolve().then(function () { return __webpack_require__(3411); });
    const sso = ssoClient ||
...
var sso = __webpack_require__(6180);
...
var client$1 = __webpack_require__(3971);
var core = __webpack_require__(9870);
var client = __webpack_require__(3910);
var config = __webpack_require__(3855);
var endpoints = __webpack_require__(4241);
var protocols = __webpack_require__(8146);
var retry = __webpack_require__(101);
var schema = __webpack_require__(7438);
var httpAuthSchemes = __webpack_require__(942);
var serde = __webpack_require__(5666);
var nodeHttpHandler = __webpack_require__(7449);
var protocols$1 = __webpack_require__(8741);
...
const getSsoOidcClient = async (ssoRegion, init = {}, callerClientConfig) => {
    const { SSOOIDCClient } = await __webpack_require__.e(/* import() */ 474).then(__webpack_require__.t.bind(__webpack_require__, 2474, 19));
...
const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}, callerClientConfig) => {
    const { CreateTokenCommand } = await __webpack_require__.e(/* import() */ 474).then(__webpack_require__.t.bind(__webpack_require__, 2474, 19));
...
//# sourceMappingURL=512.index.js.map