...
var config = __webpack_require__(3855);
var client = __webpack_require__(3971);
var credentialProviderLogin = __webpack_require__(456);

const resolveCredentialSource = (credentialSource, profileName, logger) => {
    const sourceProvidersMap = {
        EcsContainer: async (options) => {
            const { fromHttp } = await __webpack_require__.e(/* import() */ 943).then(__webpack_require__.t.bind(__webpack_require__, 4943, 19));
            const { fromContainerMetadata } = await __webpack_require__.e(/* import() */ 220).then(__webpack_require__.t.bind(__webpack_require__, 8220, 19));
        ...
        Ec2InstanceMetadata: async (options) => {
            ...
            const { fromInstanceMetadata } = await __webpack_require__.e(/* import() */ 220).then(__webpack_require__.t.bind(__webpack_require__, 8220, 19));
            return async () => fromInstanceMetadata(options)().then(setNamedProvider);
        },
        Environment: async (options) => {
            logger?.debug("@aws-sdk/credential-provider-ini - credential_source is Environment");
            const { fromEnv } = await Promise.resolve(/* import() */).then(__webpack_require__.t.bind(__webpack_require__, 7543, 19));
...
const resolveAssumeRoleCredentials = async (profileName, profiles, options, callerClientConfig, visitedProfiles = {}, resolveProfileData) => {
    ...
    if (!options.roleAssumer) {
        const { getDefaultRoleAssumer } = await __webpack_require__.e(/* import() */ 151).then(__webpack_require__.t.bind(__webpack_require__, 7151, 19));
...
const resolveProcessCredentials = async (options, profile) => __webpack_require__.e(/* import() */ 39).then(__webpack_require__.t.bind(__webpack_require__, 2039, 19)).then(({ fromProcess }) => fromProcess({
    ...options,
    profile,
...
const resolveSsoCredentials = async (profile, profileData, options = {}, callerClientConfig) => {
    const { fromSSO } = await __webpack_require__.e(/* import() */ 512).then(__webpack_require__.t.bind(__webpack_require__, 9512, 19));
    return fromSSO({
        profile,
...
const isWebIdentityProfile = (arg) => Boolean(arg) &&
    ...
    typeof arg.role_arn === "string" &&
    ["undefined", "string"].indexOf(typeof arg.role_session_name) > -1;
const resolveWebIdentityCredentials = async (profile, options, callerClientConfig) => __webpack_require__.e(/* import() */ 280).then(__webpack_require__.t.bind(__webpack_require__, 280, 23)).then(({ fromTokenFile }) => fromTokenFile({
...
var client = __webpack_require__(3971);
var config = __webpack_require__(3855);
var protocols = __webpack_require__(8146);
...
class LoginCredentialsFetcher {
    ...
    async refresh(token) {
        const { SigninClient, CreateOAuth2TokenCommand } = await __webpack_require__.e(/* import() */ 167).then(__webpack_require__.t.bind(__webpack_require__, 5167, 19));
