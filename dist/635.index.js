...
const fromWebToken_1 = __webpack_require__(9104);
...
const fromWebToken = (init) => async (awsIdentityProperties) => {
    ...
    if (!roleAssumerWithWebIdentity) {
        const { getDefaultRoleAssumerWithWebIdentity } = await Promise.resolve().then(() => __importStar(__webpack_require__(7739)));
...
var fromTokenFile = __webpack_require__(3600);
var fromWebToken = __webpack_require__(9104);
