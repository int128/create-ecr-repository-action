...
const ruleset_1 = __webpack_require__(2618);
...
var middlewareHostHeader = __webpack_require__(9058);
var middlewareLogger = __webpack_require__(5808);
var middlewareRecursionDetection = __webpack_require__(6482);
var middlewareUserAgent = __webpack_require__(5062);
...
var middlewareRetry = __webpack_require__(1960);
var smithyClient = __webpack_require__(2958);
var httpAuthSchemeProvider = __webpack_require__(6503);
var runtimeConfig = __webpack_require__(5286);
...
const package_json_1 = tslib_1.__importDefault(__webpack_require__(9807));
const core_1 = __webpack_require__(5996);
...
const runtimeConfig_shared_1 = __webpack_require__(8127);
...
const httpAuthSchemeProvider_1 = __webpack_require__(6503);
const endpointResolver_1 = __webpack_require__(1601);
const getRuntimeConfig = (config) => {
    return {
...
var client = __webpack_require__(7156);
var tokenProviders = __webpack_require__(1702);
...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, profile, filepath, configFilepath, ignoreCache, logger, }) => {
    ...
    const { SSOClient, GetRoleCredentialsCommand } = await Promise.resolve().then(function () { return __webpack_require__(781); });
    const sso = ssoClient ||
...
var clientSso = __webpack_require__(6532);
...
var client = __webpack_require__(7156);
var httpAuthSchemes = __webpack_require__(6855);
var propertyProvider = __webpack_require__(98);
var sharedIniFileLoader = __webpack_require__(2787);
...
const getSsoOidcClient = async (ssoRegion, init = {}) => {
    const { SSOOIDCClient } = await __webpack_require__.e(/* import() */ 206).then(__webpack_require__.t.bind(__webpack_require__, 9206, 19));
...
const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}) => {
    const { CreateTokenCommand } = await __webpack_require__.e(/* import() */ 206).then(__webpack_require__.t.bind(__webpack_require__, 9206, 19));
