...
const ruleset_1 = __webpack_require__(4563);
...
var middlewareUserAgent = __webpack_require__(1491);
...
var middlewareRetry = __webpack_require__(9478);
var smithyClient = __webpack_require__(4037);
var httpAuthSchemeProvider = __webpack_require__(2228);
var runtimeConfig = __webpack_require__(8365);
...
const package_json_1 = tslib_1.__importDefault(__webpack_require__(8182));
const core_1 = __webpack_require__(3519);
...
const runtimeConfig_shared_1 = __webpack_require__(5954);
...
const httpAuthSchemeProvider_1 = __webpack_require__(2228);
const endpointResolver_1 = __webpack_require__(826);
const getRuntimeConfig = (config) => {
    return {
...
var client = __webpack_require__(8503);
var tokenProviders = __webpack_require__(6043);
...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, profile, filepath, configFilepath, ignoreCache, logger, }) => {
    ...
    const { SSOClient, GetRoleCredentialsCommand } = await Promise.resolve().then(function () { return __webpack_require__(9158); });
    const sso = ssoClient ||
...
var clientSso = __webpack_require__(9195);
...
var client = __webpack_require__(8503);
var httpAuthSchemes = __webpack_require__(8741);
var propertyProvider = __webpack_require__(98);
var sharedIniFileLoader = __webpack_require__(2787);
...
const getSsoOidcClient = async (ssoRegion, init = {}) => {
    const { SSOOIDCClient } = await __webpack_require__.e(/* import() */ 693).then(__webpack_require__.t.bind(__webpack_require__, 8693, 19));
...
const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}) => {
    const { CreateTokenCommand } = await __webpack_require__.e(/* import() */ 693).then(__webpack_require__.t.bind(__webpack_require__, 8693, 19));
