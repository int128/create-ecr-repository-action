...
const ruleset_1 = __webpack_require__(4977);
...
var middlewareUserAgent = __webpack_require__(8938);
...
var httpAuthSchemeProvider = __webpack_require__(243);
var runtimeConfig = __webpack_require__(6634);
...
const package_json_1 = tslib_1.__importDefault(__webpack_require__(9347));
const core_1 = __webpack_require__(3600);
...
const runtimeConfig_shared_1 = __webpack_require__(2867);
...
const httpAuthSchemeProvider_1 = __webpack_require__(243);
const endpointResolver_1 = __webpack_require__(1853);
const getRuntimeConfig = (config) => {
    return {
...
var client = __webpack_require__(8736);
var tokenProviders = __webpack_require__(1818);
...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, profile, filepath, configFilepath, ignoreCache, logger, }) => {
    ...
    const { SSOClient, GetRoleCredentialsCommand } = await Promise.resolve().then(function () { return __webpack_require__(7633); });
    const sso = ssoClient ||
...
var clientSso = __webpack_require__(920);
...
var client = __webpack_require__(8736);
var httpAuthSchemes = __webpack_require__(6851);
var propertyProvider = __webpack_require__(98);
var sharedIniFileLoader = __webpack_require__(2787);
...
const getSsoOidcClient = async (ssoRegion, init = {}) => {
    const { SSOOIDCClient } = await __webpack_require__.e(/* import() */ 666).then(__webpack_require__.t.bind(__webpack_require__, 666, 19));
...
const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}) => {
    const { CreateTokenCommand } = await __webpack_require__.e(/* import() */ 666).then(__webpack_require__.t.bind(__webpack_require__, 666, 19));
