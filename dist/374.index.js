...
const ruleset_1 = __webpack_require__(1946);
...
var middlewareHostHeader = __webpack_require__(36);
var middlewareLogger = __webpack_require__(6610);
var middlewareRecursionDetection = __webpack_require__(4972);
var middlewareUserAgent = __webpack_require__(3094);
var configResolver = __webpack_require__(705);
var core = __webpack_require__(5443);
...
var middlewareRetry = __webpack_require__(6501);
var smithyClient = __webpack_require__(7576);
var httpAuthSchemeProvider = __webpack_require__(2487);
var runtimeConfig = __webpack_require__(3414);
...
const package_json_1 = tslib_1.__importDefault(__webpack_require__(7299));
const core_1 = __webpack_require__(2976);
...
const runtimeConfig_shared_1 = __webpack_require__(3727);
...
const httpAuthSchemeProvider_1 = __webpack_require__(2487);
const endpointResolver_1 = __webpack_require__(7697);
const getRuntimeConfig = (config) => {
    return {
...
var protocolHttp = __webpack_require__(9953);
var core = __webpack_require__(5443);
var propertyProvider = __webpack_require__(5169);
var client = __webpack_require__(2704);
var signatureV4 = __webpack_require__(3293);
...
var propertyProvider = __webpack_require__(5169);
var sharedIniFileLoader = __webpack_require__(3628);
var client = __webpack_require__(2704);
var tokenProviders = __webpack_require__(4090);
...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, callerClientConfig, profile, filepath, configFilepath, ignoreCache, logger, }) => {
    ...
    const { SSOClient, GetRoleCredentialsCommand } = await Promise.resolve().then(function () { return __webpack_require__(3313); });
    const sso = ssoClient ||
...
var clientSso = __webpack_require__(1476);
...
var client = __webpack_require__(2704);
var httpAuthSchemes = __webpack_require__(2291);
var propertyProvider = __webpack_require__(5169);
var sharedIniFileLoader = __webpack_require__(3628);
...
const getSsoOidcClient = async (ssoRegion, init = {}, callerClientConfig) => {
    const { SSOOIDCClient } = await __webpack_require__.e(/* import() */ 218).then(__webpack_require__.t.bind(__webpack_require__, 8218, 19));
...
const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}, callerClientConfig) => {
    const { CreateTokenCommand } = await __webpack_require__.e(/* import() */ 218).then(__webpack_require__.t.bind(__webpack_require__, 8218, 19));
