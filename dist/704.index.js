...
const ruleset_1 = __webpack_require__(1412);
...
var middlewareHostHeader = __webpack_require__(6422);
var middlewareLogger = __webpack_require__(1572);
var middlewareRecursionDetection = __webpack_require__(4854);
var middlewareUserAgent = __webpack_require__(8784);
...
var httpAuthSchemeProvider = __webpack_require__(49);
var runtimeConfig = __webpack_require__(8080);
...
const package_json_1 = tslib_1.__importDefault(__webpack_require__(9789));
const core_1 = __webpack_require__(3434);
...
const runtimeConfig_shared_1 = __webpack_require__(6609);
...
const httpAuthSchemeProvider_1 = __webpack_require__(49);
const endpointResolver_1 = __webpack_require__(6391);
const getRuntimeConfig = (config) => {
    return {
...
var client = __webpack_require__(4410);
var tokenProviders = __webpack_require__(2028);
...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, callerClientConfig, profile, filepath, configFilepath, ignoreCache, logger, }) => {
    ...
    const { SSOClient, GetRoleCredentialsCommand } = await Promise.resolve().then(function () { return __webpack_require__(8899); });
    const sso = ssoClient ||
...
var clientSso = __webpack_require__(2798);
...
var client = __webpack_require__(4410);
var httpAuthSchemes = __webpack_require__(2885);
var propertyProvider = __webpack_require__(4200);
var sharedIniFileLoader = __webpack_require__(5285);
...
const getSsoOidcClient = async (ssoRegion, init = {}, callerClientConfig) => {
    const { SSOOIDCClient } = await __webpack_require__.e(/* import() */ 600).then(__webpack_require__.t.bind(__webpack_require__, 8600, 19));
...
const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}, callerClientConfig) => {
    const { CreateTokenCommand } = await __webpack_require__.e(/* import() */ 600).then(__webpack_require__.t.bind(__webpack_require__, 8600, 19));
...
//# sourceMappingURL=704.index.js.map