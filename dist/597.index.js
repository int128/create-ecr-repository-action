...
const ruleset_1 = __webpack_require__(4061);
...
var middlewareUserAgent = __webpack_require__(6001);
...
var httpAuthSchemeProvider = __webpack_require__(2182);
var runtimeConfig = __webpack_require__(5711);
...
const package_json_1 = tslib_1.__importDefault(__webpack_require__(5524));
const core_1 = __webpack_require__(9901);
...
const runtimeConfig_shared_1 = __webpack_require__(5788);
...
const httpAuthSchemeProvider_1 = __webpack_require__(2182);
const endpointResolver_1 = __webpack_require__(8467);
const getRuntimeConfig = (config) => {
    return {
...
var client = __webpack_require__(3229);
var tokenProviders = __webpack_require__(8517);
...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, profile, filepath, configFilepath, ignoreCache, logger, }) => {
    ...
    const { SSOClient, GetRoleCredentialsCommand } = await Promise.resolve().then(function () { return __webpack_require__(4964); });
    const sso = ssoClient ||
...
var clientSso = __webpack_require__(8997);
...
var client = __webpack_require__(3229);
var httpAuthSchemes = __webpack_require__(3616);
var propertyProvider = __webpack_require__(98);
var sharedIniFileLoader = __webpack_require__(2787);
...
const getSsoOidcClient = async (ssoRegion, init = {}) => {
    const { SSOOIDCClient } = await __webpack_require__.e(/* import() */ 659).then(__webpack_require__.t.bind(__webpack_require__, 3659, 19));
...
const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}) => {
    const { CreateTokenCommand } = await __webpack_require__.e(/* import() */ 659).then(__webpack_require__.t.bind(__webpack_require__, 3659, 19));
