...
const core_1 = __webpack_require__(5897);
...
const ruleset_1 = __webpack_require__(8113);
...
var middlewareUserAgent = __webpack_require__(6857);
...
var httpAuthSchemeProvider = __webpack_require__(7314);
var runtimeConfig = __webpack_require__(4483);
var regionConfigResolver = __webpack_require__(2495);
var protocolHttp = __webpack_require__(6397);
var middlewareSerde = __webpack_require__(5369);
var core$1 = __webpack_require__(5897);
...
const package_json_1 = tslib_1.__importDefault(__webpack_require__(3136));
const core_1 = __webpack_require__(5897);
const util_user_agent_node_1 = __webpack_require__(5469);
...
const runtimeConfig_shared_1 = __webpack_require__(963);
...
const httpAuthSchemeProvider_1 = __webpack_require__(7314);
const endpointResolver_1 = __webpack_require__(5308);
const getRuntimeConfig = (config) => {
    return {
...
var client = __webpack_require__(4945);
...
var client = __webpack_require__(4945);
var tokenProviders = __webpack_require__(3077);
...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, profile, filepath, configFilepath, ignoreCache, logger, }) => {
    ...
    const { SSOClient, GetRoleCredentialsCommand } = await Promise.resolve().then(function () { return __webpack_require__(3344); });
    const sso = ssoClient ||
...
var clientSso = __webpack_require__(6489);
...
var client = __webpack_require__(4945);
var httpAuthSchemes = __webpack_require__(5316);
var propertyProvider = __webpack_require__(6933);
var sharedIniFileLoader = __webpack_require__(5352);
...
const getSsoOidcClient = async (ssoRegion, init = {}) => {
    const { SSOOIDCClient } = await __webpack_require__.e(/* import() */ 835).then(__webpack_require__.t.bind(__webpack_require__, 8835, 19));
...
const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}) => {
    const { CreateTokenCommand } = await __webpack_require__.e(/* import() */ 835).then(__webpack_require__.t.bind(__webpack_require__, 8835, 19));
