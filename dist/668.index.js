...
const ruleset_1 = __webpack_require__(8920);
...
var middlewareHostHeader = __webpack_require__(2380);
var middlewareLogger = __webpack_require__(6014);
var middlewareRecursionDetection = __webpack_require__(3848);
var middlewareUserAgent = __webpack_require__(4156);
var configResolver = __webpack_require__(803);
var core = __webpack_require__(3121);
var middlewareContentLength = __webpack_require__(5376);
var middlewareEndpoint = __webpack_require__(3255);
var middlewareRetry = __webpack_require__(4158);
var smithyClient = __webpack_require__(1169);
var httpAuthSchemeProvider = __webpack_require__(7469);
var runtimeConfig = __webpack_require__(4740);
var regionConfigResolver = __webpack_require__(5742);
var protocolHttp = __webpack_require__(2664);
var middlewareSerde = __webpack_require__(7602);
var core$1 = __webpack_require__(7206);
...
const package_json_1 = tslib_1.__importDefault(__webpack_require__(873));
const core_1 = __webpack_require__(7206);
...
const runtimeConfig_shared_1 = __webpack_require__(9045);
...
const httpAuthSchemeProvider_1 = __webpack_require__(7469);
const endpointResolver_1 = __webpack_require__(1283);
const getRuntimeConfig = (config) => {
    return {
...
var protocolHttp = __webpack_require__(2664);
var core = __webpack_require__(3121);
var propertyProvider = __webpack_require__(4124);
var client = __webpack_require__(2654);
var signatureV4 = __webpack_require__(8414);
...
var propertyProvider = __webpack_require__(4124);
var sharedIniFileLoader = __webpack_require__(6547);
var client = __webpack_require__(2654);
var tokenProviders = __webpack_require__(7656);
...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, profile, filepath, configFilepath, ignoreCache, logger, }) => {
    ...
    const { SSOClient, GetRoleCredentialsCommand } = await Promise.resolve().then(function () { return __webpack_require__(8687); });
    const sso = ssoClient ||
...
var clientSso = __webpack_require__(9570);
...
var client = __webpack_require__(2654);
var httpAuthSchemes = __webpack_require__(2441);
var propertyProvider = __webpack_require__(4124);
var sharedIniFileLoader = __webpack_require__(6547);
...
const getSsoOidcClient = async (ssoRegion, init = {}) => {
    const { SSOOIDCClient } = await __webpack_require__.e(/* import() */ 860).then(__webpack_require__.t.bind(__webpack_require__, 5860, 19));
...
const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}) => {
    const { CreateTokenCommand } = await __webpack_require__.e(/* import() */ 860).then(__webpack_require__.t.bind(__webpack_require__, 5860, 19));
