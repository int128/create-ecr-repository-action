...
var client = __webpack_require__(9629);
var tokenProviders = __webpack_require__(9409);
...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, callerClientConfig, profile, filepath, configFilepath, ignoreCache, logger, }) => {
    ...
    const { SSOClient, GetRoleCredentialsCommand } = await Promise.resolve().then(function () { return __webpack_require__(4593); });
    const sso = ssoClient ||
...
var sso = __webpack_require__(1301);
...
const ruleset_1 = __webpack_require__(5437);
...
var middlewareRetry = __webpack_require__(4433);
var smithyClient = __webpack_require__(4271);
var httpAuthSchemeProvider = __webpack_require__(4966);
var runtimeConfig = __webpack_require__(7839);
var regionConfigResolver = __webpack_require__(3766);
var protocolHttp = __webpack_require__(9228);
var schemas_0 = __webpack_require__(3045);
var errors = __webpack_require__(5113);
var SSOServiceException = __webpack_require__(1271);
...
const SSOServiceException_1 = __webpack_require__(1271);
...
const runtimeConfig_shared_1 = __webpack_require__(8540);
...
const httpAuthSchemeProvider_1 = __webpack_require__(4966);
const endpointResolver_1 = __webpack_require__(1952);
const schemas_0_1 = __webpack_require__(3045);
const getRuntimeConfig = (config) => {
    return {
...
const errors_1 = __webpack_require__(5113);
const SSOServiceException_1 = __webpack_require__(1271);
...
var client = __webpack_require__(9629);
var httpAuthSchemes = __webpack_require__(5024);
var propertyProvider = __webpack_require__(4036);
var sharedIniFileLoader = __webpack_require__(7016);
...
const getSsoOidcClient = async (ssoRegion, init = {}, callerClientConfig) => {
    const { SSOOIDCClient } = await __webpack_require__.e(/* import() */ 129).then(__webpack_require__.t.bind(__webpack_require__, 4129, 23));
...
const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}, callerClientConfig) => {
    const { CreateTokenCommand } = await __webpack_require__.e(/* import() */ 129).then(__webpack_require__.t.bind(__webpack_require__, 4129, 23));
...
//# sourceMappingURL=370.index.js.map