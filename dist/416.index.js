...
const core_1 = __webpack_require__(9770);
...
const ruleset_1 = __webpack_require__(8896);
...
var middlewareHostHeader = __webpack_require__(9497);
var middlewareLogger = __webpack_require__(3529);
var middlewareRecursionDetection = __webpack_require__(1993);
var middlewareUserAgent = __webpack_require__(9432);
var configResolver = __webpack_require__(8453);
var core = __webpack_require__(3574);
var middlewareContentLength = __webpack_require__(4149);
var middlewareEndpoint = __webpack_require__(1834);
var middlewareRetry = __webpack_require__(1269);
var smithyClient = __webpack_require__(9608);
var httpAuthSchemeProvider = __webpack_require__(9893);
var runtimeConfig = __webpack_require__(892);
...
var core$1 = __webpack_require__(9770);
...
const package_json_1 = tslib_1.__importDefault(__webpack_require__(7229));
const core_1 = __webpack_require__(9770);
const util_user_agent_node_1 = __webpack_require__(10);
...
const runtimeConfig_shared_1 = __webpack_require__(6157);
...
const httpAuthSchemeProvider_1 = __webpack_require__(9893);
const endpointResolver_1 = __webpack_require__(5067);
const getRuntimeConfig = (config) => {
    return {
...
var protocolHttp = __webpack_require__(6397);
var core = __webpack_require__(3574);
var propertyProvider = __webpack_require__(6933);
var client = __webpack_require__(8650);
var signatureV4 = __webpack_require__(7609);
...
var propertyProvider = __webpack_require__(6933);
var sharedIniFileLoader = __webpack_require__(5352);
var client = __webpack_require__(8650);
var tokenProviders = __webpack_require__(1472);
...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, profile, filepath, configFilepath, ignoreCache, logger, }) => {
    ...
    const { SSOClient, GetRoleCredentialsCommand } = await Promise.resolve().then(function () { return __webpack_require__(3987); });
    const sso = ssoClient ||
...
var clientSso = __webpack_require__(650);
...
var client = __webpack_require__(8650);
var httpAuthSchemes = __webpack_require__(5413);
var propertyProvider = __webpack_require__(6933);
var sharedIniFileLoader = __webpack_require__(5352);
...
const getSsoOidcClient = async (ssoRegion, init = {}) => {
    const { SSOOIDCClient } = await __webpack_require__.e(/* import() */ 572).then(__webpack_require__.t.bind(__webpack_require__, 2572, 19));
...
const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}) => {
    const { CreateTokenCommand } = await __webpack_require__.e(/* import() */ 572).then(__webpack_require__.t.bind(__webpack_require__, 2572, 19));
