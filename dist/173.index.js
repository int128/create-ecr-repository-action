...
const ruleset_1 = __webpack_require__(9469);
...
var middlewareUserAgent = __webpack_require__(9141);
...
var httpAuthSchemeProvider = __webpack_require__(4310);
var runtimeConfig = __webpack_require__(8831);
...
var core$1 = __webpack_require__(4029);
...
const package_json_1 = tslib_1.__importDefault(__webpack_require__(3252));
const core_1 = __webpack_require__(4029);
...
const runtimeConfig_shared_1 = __webpack_require__(2172);
...
const httpAuthSchemeProvider_1 = __webpack_require__(4310);
const endpointResolver_1 = __webpack_require__(8512);
const getRuntimeConfig = (config) => {
    return {
...
var client = __webpack_require__(797);
var tokenProviders = __webpack_require__(7577);
...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, profile, filepath, configFilepath, ignoreCache, logger, }) => {
    ...
    const { SSOClient, GetRoleCredentialsCommand } = await Promise.resolve().then(function () { return __webpack_require__(6388); });
    const sso = ssoClient ||
...
var clientSso = __webpack_require__(6885);
...
var client = __webpack_require__(797);
var httpAuthSchemes = __webpack_require__(848);
var propertyProvider = __webpack_require__(6933);
var sharedIniFileLoader = __webpack_require__(5352);
...
const getSsoOidcClient = async (ssoRegion, init = {}) => {
    const { SSOOIDCClient } = await __webpack_require__.e(/* import() */ 519).then(__webpack_require__.t.bind(__webpack_require__, 519, 19));
...
const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}) => {
    const { CreateTokenCommand } = await __webpack_require__.e(/* import() */ 519).then(__webpack_require__.t.bind(__webpack_require__, 519, 19));
