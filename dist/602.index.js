...
const ruleset_1 = __webpack_require__(5846);
...
var middlewareHostHeader = __webpack_require__(8784);
var middlewareLogger = __webpack_require__(2374);
var middlewareRecursionDetection = __webpack_require__(4216);
var middlewareUserAgent = __webpack_require__(8738);
...
var httpAuthSchemeProvider = __webpack_require__(3371);
var runtimeConfig = __webpack_require__(7794);
...
const package_json_1 = tslib_1.__importDefault(__webpack_require__(567));
const core_1 = __webpack_require__(3364);
...
const runtimeConfig_shared_1 = __webpack_require__(2235);
...
const httpAuthSchemeProvider_1 = __webpack_require__(3371);
const endpointResolver_1 = __webpack_require__(293);
const getRuntimeConfig = (config) => {
    return {
...
var client = __webpack_require__(3311);
var tokenProviders = __webpack_require__(8334);
...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, callerClientConfig, profile, filepath, configFilepath, ignoreCache, logger, }) => {
    ...
    const { SSOClient, GetRoleCredentialsCommand } = await Promise.resolve().then(function () { return __webpack_require__(1205); });
    const sso = ssoClient ||
...
var clientSso = __webpack_require__(3200);
...
var client = __webpack_require__(3311);
var httpAuthSchemes = __webpack_require__(4959);
var propertyProvider = __webpack_require__(4200);
var sharedIniFileLoader = __webpack_require__(5285);
...
const getSsoOidcClient = async (ssoRegion, init = {}, callerClientConfig) => {
    const { SSOOIDCClient } = await __webpack_require__.e(/* import() */ 814).then(__webpack_require__.t.bind(__webpack_require__, 4814, 19));
...
const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}, callerClientConfig) => {
    const { CreateTokenCommand } = await __webpack_require__.e(/* import() */ 814).then(__webpack_require__.t.bind(__webpack_require__, 4814, 19));
