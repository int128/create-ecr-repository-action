...
var tokenProviders = __webpack_require__(9933);
...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, callerClientConfig, profile, filepath, configFilepath, ignoreCache, logger, }) => {
    ...
    const { SSOClient, GetRoleCredentialsCommand } = await Promise.resolve().then(function () { return __webpack_require__(4361); });
    const sso = ssoClient ||
...
var sso = __webpack_require__(5442);
...
var client$1 = __webpack_require__(754);
...
var httpAuthSchemes = __webpack_require__(2381);
var serde = __webpack_require__(4640);
var nodeHttpHandler = __webpack_require__(9169);
var protocols$1 = __webpack_require__(4318);
...
const getSsoOidcClient = async (ssoRegion, init = {}, callerClientConfig) => {
    const { SSOOIDCClient } = await __webpack_require__.e(/* import() */ 164).then(__webpack_require__.t.bind(__webpack_require__, 4164, 19));
...
const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}, callerClientConfig) => {
    const { CreateTokenCommand } = await __webpack_require__.e(/* import() */ 164).then(__webpack_require__.t.bind(__webpack_require__, 4164, 19));
