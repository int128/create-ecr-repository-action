...
const ruleset_1 = __webpack_require__(3441);
...
var middlewareUserAgent = __webpack_require__(7820);
...
var httpAuthSchemeProvider = __webpack_require__(7154);
var runtimeConfig = __webpack_require__(1219);
...
const package_json_1 = tslib_1.__importDefault(__webpack_require__(1100));
const core_1 = __webpack_require__(7202);
...
const runtimeConfig_shared_1 = __webpack_require__(4848);
...
const httpAuthSchemeProvider_1 = __webpack_require__(7154);
const endpointResolver_1 = __webpack_require__(9836);
const getRuntimeConfig = (config) => {
    return {
...
var client = __webpack_require__(3730);
var tokenProviders = __webpack_require__(9809);
...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, callerClientConfig, profile, filepath, configFilepath, ignoreCache, logger, }) => {
    ...
    const { SSOClient, GetRoleCredentialsCommand } = await Promise.resolve().then(function () { return __webpack_require__(5980); });
    const sso = ssoClient ||
...
var clientSso = __webpack_require__(9001);
...
var client = __webpack_require__(3730);
var httpAuthSchemes = __webpack_require__(5709);
var propertyProvider = __webpack_require__(5169);
var sharedIniFileLoader = __webpack_require__(3628);
...
const getSsoOidcClient = async (ssoRegion, init = {}, callerClientConfig) => {
    const { SSOOIDCClient } = await __webpack_require__.e(/* import() */ 231).then(__webpack_require__.t.bind(__webpack_require__, 1231, 19));
...
const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}, callerClientConfig) => {
    const { CreateTokenCommand } = await __webpack_require__.e(/* import() */ 231).then(__webpack_require__.t.bind(__webpack_require__, 1231, 19));
